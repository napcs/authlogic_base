== Authlogic_Base
This is a starter app for my Rails projects that has all of the usual user setup stuff in place. You can follow these instructions to get everything set up, but then you can just modify this readme for your own apps.
